          ...
          <Row>
            ...
            <Col lg='6'>
              <div className="product_details">
                <h2>{productName}</h2>
                <div className='product_rating d-flex align-center gap-5 mb-3'>
                  <div>
                    <span>
                ...
                <span className='mt-3'>{shortDesc}</span><br/>
                  ...
                  <div className="review_wrapper">
                    ...
                    <div className="review_form">
                      ...
                      <form action="" onSubmit={submitHandler}>
                        ...
                        <div className="form_group">
                          <textarea row={4} col={10} type='text' placeholder='Review Message...'  ref={reviewMsg} required/>
                        </div>
